    ...
    <Tabs
      ...
      tabBar={(props) => {
        ...
        function renderTab(routeName: string) {
          ...
          return (
            <HapticTab accessibilityState={{ selected: isFocused }} onPress={onPress}>
              <IconSymbol size={32} name={iconName} color={isFocused ? tint : defaultIconColor} style={styles.icon}/>
            </HapticTab>
          );
        }
